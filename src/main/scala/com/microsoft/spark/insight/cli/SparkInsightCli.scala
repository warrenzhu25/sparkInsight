...
import org.apache.spark.insight.analyzer.{AppDiffAnalyzer, AppSummaryAnalyzer, AutoScalingAnalyzer, ConfigDiffAnalyzer, ExecutorAnalyzer, FailedTaskAnalyzer, ShuffleSkewAnalyzer, StageLevelDiffAnalyzer}
